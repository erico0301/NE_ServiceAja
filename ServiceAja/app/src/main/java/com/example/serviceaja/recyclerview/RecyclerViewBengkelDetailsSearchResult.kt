...
class RecyclerViewBengkelDetailsSearchResult : RecyclerView.Adapter<RecyclerViewBengkelDetailsSearchResult.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context)
            .inflate(R.layout.recyclerview_bengkel_details_search_result, parent, false)
