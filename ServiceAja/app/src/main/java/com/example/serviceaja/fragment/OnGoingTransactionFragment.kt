 ...
 * Use the [OnGoingTransactionFragment.newInstance] factory method to
...
class OnGoingTransactionFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment OnGoingTransactionFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                OnGoingTransactionFragment().apply {
